...
const RegisterForm = () => {
  return (
    <div className="bg-bgGreen border flex flex-col border-mainGreen w-auto h-auto p-10 rounded-lg">
      ...
      <input name="projectName" className="mt-3 px-2 w-[200px] h-[30px] border border-subTxt rounded-lg" type="text" />
      ...
      <input type="file" className="file-input file-input-bordered w-[400px] mt-3 h-[30px] max-w-xs" />
