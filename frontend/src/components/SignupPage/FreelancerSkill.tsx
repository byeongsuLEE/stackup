      ...
      <form onSubmit={handleSubmit(onsubmit)}>
        <div className="bg-bgGreen flex flex-col w-[900px] h-auto border border-mainGreen ">
          ...
          <div className="flex flex-col ml-10">
            ...
            <div 
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => choiceLanguage(e.target.value)}
            >
            <div className="flex">
            ...
            {...register('portfolioURL', { required: '포트폴리오 URL을 입력해주세요.' })}
            />
            ...
            type="text"
            className="px-2 mt-2 border border-subGreen2 w-72 h-10 rounded-xl"
            {...register('selfIntroduction', { required: '자기소개를 입력해주세요.' })}
            />
          </div>
