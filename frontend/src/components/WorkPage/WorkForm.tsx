      ...
      <div className="bg-bgGreen flex flex-col px-20 py-10 mt-10 w-[900px] h-auto border border-mainGreen ">
        ...
        <div className='flex mt-5'>
          <div className='flex flex-col mr-32'>
            ...
            <label className='mt-3' htmlFor="postPeriod">공고 기간</label>
          ...
          <div className='flex flex-col'>
            ...
            <textarea name='projectInfo' className='border mt-3 border-slate-300 h-40 rounded-lg' />
            <input name='budget' className='border border-slate-300 rounded-lg w-96 mt-3' type="text" />
            <input name='projectStart' className='border border-slate-300 rounded-lg w-96 mt-3' type="text" />
            <input name='projectPeriod' className='border border-slate-300 rounded-lg w-96 mt-3' type="text" />
            <input name='postPeriod' className='border border-slate-300 rounded-lg w-96 mt-3' type="text" />
            <input name='workType' className='border border-slate-300 rounded-lg w-96 mt-3' type="text" />
