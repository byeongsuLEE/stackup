...
// NFT 스마트 계약 주소
const NFT_CONTRACT_ADDRESS = '0xdb5b441e10830A042aA55669888eBA675a3261dF';
...
export const CallTest = () => {
  ...
  const Minting = async (
    ...
    // NFT 스마트 계약 주소
    // const NFT_CONTRACT_ADDRESS = '0xF8a720831bb464d87937b3e024E2F0bb3e09EF9a';
    const metadataURI = `https://turquoise-rational-locust-574.mypinata.cloud/ipfs/${cid}`; // IPFS CID를 URI로 사용
